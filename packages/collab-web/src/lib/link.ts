 ...
 * link/envelope half of `@wxyhgk/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@wxyhgk/pi-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@wxyhgk/pi-wire";
