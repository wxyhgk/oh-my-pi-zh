...
import { serializeConversation, serializeConversationForSummary } from "@wxyhgk/pi-agent-core/compaction";
import type { AssistantMessage, Message, ToolResultMessage, Usage } from "@wxyhgk/pi-ai";
