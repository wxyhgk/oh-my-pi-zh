import { Box, type Component, Markdown } from "@wxyhgk/pi-tui";
		...
		this.#divider = new SummaryDividerComponent({
			...
			label: () =>
				this.message.warning
					? `${theme.icon.camera} 已压缩 ${theme.fg("warning", theme.icon.warning)}`
					: `${theme.icon.camera} 已压缩`,
