import { routeSelectListMouse, type SelectItem, SelectList, type SgrMouseEvent } from "@wxyhgk/pi-tui";
...
class GlyphSceneController implements SetupSceneController {
	...
	render(width: number): readonly string[] {
		const lines = [theme.fg("muted", "如果某行显示为方框、豆腐块或图标错位,请选择其他行。"), ""];
