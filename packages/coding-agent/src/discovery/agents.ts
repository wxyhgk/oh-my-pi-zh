...
const DISPLAY_NAME = "Agent 目录(.agent/.agents)";
const PRIORITY = 70;
...
registerProvider<Skill>(skillCapability.id, {
	...
	description: "从 .agent/skills 和 .agents/skills 加载技能(项目向上查找 + 用户主目录)",
	priority: PRIORITY,
	load: loadSkills,
});
...
registerProvider<Rule>(ruleCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .agent/rules 和 .agents/rules 加载规则(项目向上查找 + 用户主目录)",
	priority: PRIORITY,
	load: loadRules,
});
...
registerProvider<Prompt>(promptCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .agent/prompts 和 .agents/prompts 加载提示词(项目向上查找 + 用户主目录)",
	priority: PRIORITY,
	load: loadPrompts,
});
...
registerProvider<SlashCommand>(slashCommandCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .agent/commands 和 .agents/commands 加载命令(项目向上查找 + 用户主目录)",
	priority: PRIORITY,
...
registerProvider<ContextFile>(contextFileCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .agent 和 .agents 加载 AGENTS.md(项目向上查找 + 用户主目录)",
	priority: PRIORITY,
...
registerProvider<SystemPrompt>(systemPromptCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .agent 和 .agents 加载 SYSTEM.md(项目向上查找 + 用户主目录)",
	priority: PRIORITY,
