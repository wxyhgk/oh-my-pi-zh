...
function transformInstructionRule(
	...
	if (!applyToGlobs) {
		warnings.push(`缺少 applyTo:${filePath};已加载但无 GitHub glob 作用域。`);
	}
...
registerProvider(contextFileCapability.id, {
	...
	description:
		"从 .github/ 和 ~/.copilot/ 加载 copilot-instructions.md;从 COPILOT_CUSTOM_INSTRUCTIONS_DIRS 加载 AGENTS.md",
	priority: PRIORITY,
...
registerProvider(instructionCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .github/instructions/ 和 COPILOT_CUSTOM_INSTRUCTIONS_DIRS 加载 *.instructions.md",
	priority: PRIORITY,
...
registerProvider<Rule>(ruleCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "将 .github/instructions/ 中的 *.instructions.md 作为 Copilot 作用域规则加载",
	priority: PRIORITY,
	load: loadRules,
});
registerProvider<Skill>(skillCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .github/skills/*/SKILL.md 加载技能",
	priority: PRIORITY,
	load: loadSkills,
});
...
registerProvider<Prompt>(promptCapability.id, {
	id: PROVIDER_ID,
	displayName: DISPLAY_NAME,
	description: "从 .github/prompts/ 加载 *.prompt.md(VS Code Copilot 提示词文件)",
	priority: PRIORITY,
	load: loadPrompts,
});
