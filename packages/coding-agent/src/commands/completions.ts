...
import { APP_NAME, VERSION } from "@wxyhgk/pi-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@wxyhgk/pi-utils/cli";
...
export default class Completions extends Command {
	...
	async run(): Promise<void> {
		...
		const config: CliConfig = { bin: "omp-zh", version: VERSION, commands: map };
