...
export const handleCoinGecko: SpecialHandler = async (
	...
	try {
		...
		return buildResult(md, { url, method: "coingecko", fetchedAt, notes: ["通过 CoinGecko API 获取"] });
	} catch {}
