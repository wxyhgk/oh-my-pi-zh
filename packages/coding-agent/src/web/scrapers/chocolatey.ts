...
export const handleChocolatey: SpecialHandler = async (
	...
	try {
		...
		return buildResult(md, { url, method: "chocolatey", fetchedAt, notes: ["通过 Chocolatey NuGet API 获取"] });
	} catch {}
