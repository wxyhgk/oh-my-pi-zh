...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@wxyhgk/pi-ai";
...
// Per-provider image-count budgets live in @wxyhgk/snapcompact
