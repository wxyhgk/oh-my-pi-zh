...
import type { CompactionPreparation, CompactionResult } from "@wxyhgk/pi-agent-core/compaction";
import type { AssistantRetryRecovery, ImageContent, TextContent, ToolResultMessage } from "@wxyhgk/pi-ai";
