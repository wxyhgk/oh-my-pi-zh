...
import type { StatusLineSegmentId } from "@wxyhgk/pi-coding-agent/config/settings-schema";
...
import { getSessionAccentAnsi, getSessionAccentHex } from "@wxyhgk/pi-coding-agent/utils/session-color";
