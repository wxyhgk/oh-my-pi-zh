...
} from "@wxyhgk/pi-coding-agent/slash-commands/builtin-registry";
import { CollabQrCodeComponent } from "@wxyhgk/pi-coding-agent/slash-commands/helpers/collab-qrcode";
import { Spacer } from "@wxyhgk/pi-tui";
