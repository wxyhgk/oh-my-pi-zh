...
import type { MarketplacePluginEntry } from "@wxyhgk/pi-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@wxyhgk/pi-coding-agent/extensibility/plugins/marketplace";
