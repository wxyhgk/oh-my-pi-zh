...
describe("EvalTool display() text surfacing", () => {
	...
	it("interleaves stdout text and display() JSON values", async () => {
		...
		expect(text.indexOf("before")).toBeLessThan(text.indexOf("显示[1]"));
