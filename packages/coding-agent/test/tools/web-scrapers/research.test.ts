...
import { handleBiorxiv } from "@wxyhgk/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@wxyhgk/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@wxyhgk/pi-coding-agent/web/scrapers/wikidata";
