...
import { handleHuggingFace } from "@wxyhgk/pi-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@wxyhgk/pi-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@wxyhgk/pi-coding-agent/web/scrapers/vimeo";
