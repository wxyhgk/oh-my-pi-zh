...
import { handleCratesIo } from "@wxyhgk/pi-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@wxyhgk/pi-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@wxyhgk/pi-coding-agent/web/scrapers/hex";
import { handleNpm } from "@wxyhgk/pi-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@wxyhgk/pi-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@wxyhgk/pi-coding-agent/web/scrapers/pypi";
