...
import { handleChocolatey } from "@wxyhgk/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@wxyhgk/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@wxyhgk/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@wxyhgk/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@wxyhgk/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@wxyhgk/pi-coding-agent/web/scrapers/terraform";
