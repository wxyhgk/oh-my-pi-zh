...
import { handleAur } from "@wxyhgk/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@wxyhgk/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@wxyhgk/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@wxyhgk/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@wxyhgk/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@wxyhgk/pi-coding-agent/web/scrapers/rubygems";
