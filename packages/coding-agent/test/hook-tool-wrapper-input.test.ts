...
import { HookRunner, type LoadedHook } from "@wxyhgk/pi-coding-agent/extensibility/hooks";
import { HookToolWrapper } from "@wxyhgk/pi-coding-agent/extensibility/hooks/tool-wrapper";
