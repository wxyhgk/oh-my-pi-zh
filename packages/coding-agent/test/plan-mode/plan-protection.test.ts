...
import type { AgentToolCall } from "@wxyhgk/pi-agent-core";
import type { SessionMessageEntry } from "@wxyhgk/pi-agent-core/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@wxyhgk/pi-agent-core/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@wxyhgk/pi-agent-core/compaction/shake";
import type { ProtectedToolContext } from "@wxyhgk/pi-agent-core/compaction/tool-protection";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@wxyhgk/pi-ai";
import { createPlanReadMatcher } from "@wxyhgk/pi-coding-agent/plan-mode/plan-protection";
