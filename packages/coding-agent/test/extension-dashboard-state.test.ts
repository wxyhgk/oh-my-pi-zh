...
import { applyDisabledExtensionsToState } from "@wxyhgk/pi-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@wxyhgk/pi-coding-agent/modes/components/extensions/types";
