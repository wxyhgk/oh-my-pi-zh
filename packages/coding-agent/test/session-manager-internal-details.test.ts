...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@wxyhgk/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@wxyhgk/pi-coding-agent/session/session-entries";
