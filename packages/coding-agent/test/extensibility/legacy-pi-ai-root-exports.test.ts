...
import type { AssistantMessage, FetchImpl } from "@wxyhgk/pi-ai";
...
} from "@wxyhgk/pi-coding-agent/extensibility/legacy-pi-ai-shim";
...
// helpers moved to `@oh-my-pi/pi-utils`, so `export * from "@wxyhgk/pi-ai"` left
