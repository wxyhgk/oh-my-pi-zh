...
import {
	...
	ORCHESTRATE_NOTICE,
} from "@wxyhgk/pi-coding-agent/modes/orchestrate";
import { initTheme } from "@wxyhgk/pi-coding-agent/modes/theme/theme";
import { containsUltrathink, highlightUltrathink } from "@wxyhgk/pi-coding-agent/modes/ultrathink";
import { clearBundledCommandsCache, loadBundledCommands } from "@wxyhgk/pi-coding-agent/task/commands";
...
describe("orchestrate notice", () => {
	it("is a self-contained system notice carrying the orchestration contract", () => {
		...
		expect(ORCHESTRATE_NOTICE).toContain("编排者");
