...
import { PluginManager } from "@wxyhgk/pi-coding-agent/extensibility/plugins";
import {
	type InstalledPluginSummary,
	MarketplaceManager,
} from "@wxyhgk/pi-coding-agent/extensibility/plugins/marketplace";
import type { InstalledPlugin } from "@wxyhgk/pi-coding-agent/extensibility/plugins/types";
import {
	MarketplacePluginDetailComponent,
	PluginListComponent,
	type PluginListEntry,
	PluginSettingsComponent,
} from "@wxyhgk/pi-coding-agent/modes/components/plugin-settings";
