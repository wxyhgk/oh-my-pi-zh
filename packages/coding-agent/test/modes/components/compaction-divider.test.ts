 ...
 * `── 📷 已压缩 · ctrl+o ──` — instead of a full summary box, keeping the
...
import { createCompactionSummaryMessage } from "@wxyhgk/pi-agent-core/compaction";
import type { ImageContent } from "@wxyhgk/pi-ai";
import { CompactionSummaryMessageComponent } from "@wxyhgk/pi-coding-agent/modes/components/compaction-summary-message";
