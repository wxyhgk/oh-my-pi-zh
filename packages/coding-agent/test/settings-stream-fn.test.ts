...
import type { Context, Model, SimpleStreamOptions } from "@wxyhgk/pi-ai";
...
import { createSettingsAwareStreamFn } from "@wxyhgk/pi-coding-agent/session/settings-stream-fn";
