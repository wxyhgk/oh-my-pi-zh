...
import { InteractiveMode, renderSubagentHudLines } from "@wxyhgk/pi-coding-agent/modes/interactive-mode";
import {
...
} from "@wxyhgk/pi-coding-agent/task";
...
describe("subagent HUD lines", () => {
	...
	it("renders the first eight active detached subagents and summarizes the rest", () => {
		...
		expect(out).toContain("还有 2 个正在运行");
	});
});
