...
} from "@wxyhgk/pi-coding-agent/extensibility/plugins/loader";
import type { InstalledPlugin, PluginManifest } from "@wxyhgk/pi-coding-agent/extensibility/plugins/types";
