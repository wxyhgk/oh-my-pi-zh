...
import { loadCapability, setDisabledProviders } from "@wxyhgk/pi-coding-agent/capability";
import type { ContextFile } from "@wxyhgk/pi-coding-agent/capability/context-file";
import { clearCache } from "@wxyhgk/pi-coding-agent/capability/fs";
import type { Instruction } from "@wxyhgk/pi-coding-agent/capability/instruction";
import type { Prompt } from "@wxyhgk/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@wxyhgk/pi-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@wxyhgk/pi-coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@wxyhgk/pi-utils";
import "@wxyhgk/pi-coding-agent/capability/context-file";
import "@wxyhgk/pi-coding-agent/capability/instruction";
import "@wxyhgk/pi-coding-agent/capability/prompt";
import "@wxyhgk/pi-coding-agent/capability/rule";
import "@wxyhgk/pi-coding-agent/discovery/github";
