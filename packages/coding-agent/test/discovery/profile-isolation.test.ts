...
import { type Skill, skillCapability } from "@wxyhgk/pi-coding-agent/capability/skill";
import { type SlashCommand, slashCommandCapability } from "@wxyhgk/pi-coding-agent/capability/slash-command";
