...
import { buildAnthropicClientOptions, streamAnthropic } from "@wxyhgk/pi-ai/providers/anthropic";
import type { Context, Model } from "@wxyhgk/pi-ai/types";
import { buildAnthropicUrl } from "@wxyhgk/pi-ai/utils/anthropic-auth";
import { buildModel } from "@wxyhgk/pi-catalog/build";
import { OPENCODE_HEADERS } from "@wxyhgk/pi-catalog/wire/github-copilot";
